<section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				<h2>Conócenos</h2>
				<p class="lead">En World Tur . . .   <br> Tenemos los siguientes propósitos:</p>
			</div>
			...
			<div class="team">
				...
				<div class="row clearfix">
						...
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="<?php echo base_url();?>img/vision (2).png" alt=""></a>
								</div>
					...
					<div class="col-md-4 col-sm-6">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="<?php echo base_url();?>img/mision.png" alt=""></a>
								</div>
								<div class="media-body">
									<h4>Misión</h4>
