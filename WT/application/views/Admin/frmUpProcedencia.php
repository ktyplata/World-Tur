...
<form action="<?php echo base_url();?>index.php/Procedencia/upProcedencia" method="post">
   ...
   <input type="hidden" name ="idProcedencia" value="<?php echo $n->idProcedencia; ?>">
    ...
    <div class="form-group input-group">
         ...
         <input class="form-control" id="datetimepicker" type="datetime" id="HorarioSalida" name="HorarioSalida" placeholder="Horario Salida" required="required" value="<?php echo $n->HorarioSalida; ?>">
    </div>
